# analysis/tradingmodule_250806j.py
...
SKRIPT_ID = "tradingmodule_250806j"
RESULTS_DIR = "results"
...
for k, dv in DEFAULT_PARAMS.items():
    if k not in global_params:
        ...
        print(f"[INFO] Standardwert ergänzt: {k} = {dv}")
    else:
...
def main():
    ...
    from .mod_markdown import export_params_to_markdown
